const CACHE_NAME = 'aura-connect-v91';
const ASSETS = [
  './index.html',
  './manifest.json',
  ...
  './assets/ui/halloween_battle.webp',
  './assets/enemy/hw_gost.webp',
  './assets/enemy/hw_mycol.webp',
  ...
  './assets/enemy/arcanacauldron_fire.webp',
  './assets/enemy/arcanacauldron_wood.webp',
  './assets/enemy/arcanacauldron_heal.webp',
  ...
  './src/js/core/gift-materials.js',
  './src/js/data/gamedata.js',
  './src/js/data/availability.js',
  './src/js/screens/event.js',
  './src/js/data/enemies.js',
  './src/js/data/enemy-master.js',
  './src/js/data/raids.js',
  './src/js/data/raid-rewards.js',
  './src/js/data/event-drops.js',
  './src/js/data/gacha-campaigns.js',
